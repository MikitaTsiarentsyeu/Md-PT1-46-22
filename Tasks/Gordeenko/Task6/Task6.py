...
def sum_recursion_list(l, counter = 0):
    for item in l:
        ...
        #print(item)
            #print(item)
    return counter
print(f"Сумма всех элементов вложенных списков = ", sum_recursion_list(l))
...
print(f"{[fib(n) for n in range(n)]} ряд Фибоначчи 'с 0' ")   
print(f"{[fib(n) for n in range(1,n+1)]} ряд Фибоначчи 'без 0' ")
